...
- **🌐 Мульти-источники** — интеграция с NewsAPI, The Guardian и другими API
- **🎯 Персонализация** — избранные категории, сохранение статей, настройки отображения
...
**Важно:** В `DJANGO_ALLOWED_HOSTS` указывайте хосты через пробел, без запятых!
...
3. **Reddit API** (опционально) — [получить ключ](https://www.reddit.com/prefs/apps)
...
|-----|------------|--------|
| **NewsAPI** | Основной поиск новостей, топ новости | 100 запросов/день |
...
# Откройте locale/ru/LC_MESSAGES/django.po
